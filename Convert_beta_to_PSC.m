...
%Convert Beta-values to Percent Signal Change (Pernet, 2014)
...
%This is example for single subject

%estimate GLM fot single subject using SPM12
%load SPM.mat 
...
SF=max(SPM.xBF.bf(:,1))/SPM.xBF.dt;
